...
/**
 * Inline alert for form/modal failures. Shows the server message, optional
 * field-level lines, and a short resolution hint when available.
 */
export function FormErrorBanner({
  error,
  className = "",
  /** Set false when the form already maps fieldErrors onto individual inputs. */
  showFieldList = true,
}: {
